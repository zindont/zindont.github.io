...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://zindont.github.io/opengraph-image",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: `${RESUME_DATA.name} - Resume`,
    description: RESUME_DATA.about,
    images: ["https://zindont.github.io/opengraph-image"],
  },
};
...
export default function ResumePage() {
  ...
  return (
    <>
      ...
      />
      <main
        className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-11 md:p-10"
        id="main-content"
      >
        ...
        <section
          className="resume-surface mx-auto w-full max-w-3xl space-y-8 print:space-y-4"
