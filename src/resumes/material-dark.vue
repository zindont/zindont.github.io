<template>
  <div class="resume">
    <div class="leftCol col m_box">
      ...
      <a :href="contactLinks.phone" v-if="contactLinks.phone">
        <div class="item">
          <div class="icon">
    ...
    <div class="rightCol col">
      ...
      >
        ...
        <div class="subheadline" v-if="experience.website">
...
import Projects from "@/components/materialDarkProjects";
